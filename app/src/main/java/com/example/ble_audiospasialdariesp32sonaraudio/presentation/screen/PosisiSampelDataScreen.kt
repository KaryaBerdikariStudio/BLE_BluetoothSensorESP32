        ...
        Column(
            ...
            when (connectionState) {
                ConnectionState.Connected -> {
                    ...
                    var roll by remember { mutableStateOf(listDataSudut.roll.toString()) }
                    var pitch by remember { mutableStateOf(listDataSudut.pitch.toString()) }
                    var yaw by remember { mutableStateOf(listDataSudut.yaw.toString()) }
